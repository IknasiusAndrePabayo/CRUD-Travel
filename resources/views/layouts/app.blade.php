            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        ...
                        @endcanany
                        @canany(['create-travel_packages', 'edit-travel_packages', 'delete-travel_packages'])
                            <li><a class="nav-link" href="{{ route('travel_packages.index') }}">Manage Products</a></li>
                        @endcanany
                        @canany(['create-pesanan', 'edit-pesanan', 'delete-pesanan'])
                            <li><a class="nav-link" href="{{ route('pesanan.index') }}">Manage pesanan</a></li>
                        @endcanany
